...
shapefile="/home/adeline/Dropbox/github_projects/geoserver-mosaics/shapefiles/limite_mata_atlantica/mata_atlantica_border_4326_newIBGE.shp" # <- CHANGE ME
printf $shapefile

#shapefile_grid="/[path]/shapefiles/limite_mata_atlantica/grid_landsat_tm_Mata_Atlantica_crop_4326_newIBGE_v2.shp" # <- CHANGE ME
shapefile_grid="/home/adeline/Dropbox/github_projects/geoserver-mosaics/shapefiles/limite_mata_atlantica/grid_landsat_tm_Mata_Atlantica_crop_4326_newIBGE_v2.shp" # <- CHANGE ME
printf $shapefile_grid

#rscript_file="/[path]/mata_atlantica/script_r_cut_images_by_grid_mata_atlantica.R" # <- CHANGE ME
rscript_file="/home/adeline/Dropbox/github_projects/geoserver-mosaics/mata_atlantica/script_r_cut_images_by_grid_mata_atlantica.R" # <- CHANGE ME
printf $rscript_file
