...
if (length(args)==2) {
  ...
  # shape <-  "/home/user/Mosaic_1986_2022_NF/shapefiles/grid_landsat_brazilian_legal_amazon_4326.shp"
  cat("shapefile path: '", shape, "' \n")
  rasterFolder <- as.character(args[2])
  # rasterFolder <- "/home/user/Filebrowser/2000/tempCopy/tempEPSG4326/"
