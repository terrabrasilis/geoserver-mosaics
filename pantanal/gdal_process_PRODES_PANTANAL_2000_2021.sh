...
if [ "$#" -eq 1 ]
    ...
    echo "Example: /path/gdal_process_PRODES_PANTANAL_2000_2021.sh 2018"
    echo
    exit 1
    fi
...
shapefile="/home/adeline/Dropbox/github_projects/geoserver-mosaics/shapefiles/limite_pantanal/biome_border_4326_newIBGE.shp" # <- CHANGE ME
printf $shapefile

#shapefile_grid="/[path]/shapefiles/limite_pantanal/grid_landsat_tm_Pantanal_crop_4326_newIBGE_v2.shp" # <- CHANGE ME
shapefile_grid="/home/adeline/Dropbox/github_projects/geoserver-mosaics/shapefiles/limite_pantanal/grid_landsat_tm_Pantanal_crop_4326_newIBGE_v2.shp" # <- CHANGE ME
printf $shapefile_grid

#rscript_file="/[path]/pantanal/script_r_cut_images_by_grid_pantanal.R" # <- CHANGE ME
rscript_file="/home/adeline/Dropbox/github_projects/geoserver-mosaics/pantanal/script_r_cut_images_by_grid_pantanal.R" # <- CHANGE ME
printf $rscript_file
