...
# NOTE: change nodata value to 0, projection to EPSG: 4326, and merge scenes as a mosaic. Years of 2006, from 2008 to 2011, and from and 2013 to 2018.
...
if [ "$#" -eq 1 ]
    ...
    echo "Example: path/gdal_process_PRODES_AMZ_2006_2008-2011_2013-2019_valpha_legal_amz.sh 2020"
    echo
    exit 1
    fi
...
rscript_file="/[path]/script_r_cut_images_by_grid_2006_2019.R"
